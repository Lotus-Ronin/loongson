...
if __name__ == "__main__":
    ...
    net_file = "/DEngine/model/rubbish/net.bin"
    model_file = "/DEngine/model/rubbish/model.bin"
    img_dir = "/DEngine/data/images/"
    label_path = "./rubbish/classes.txt"
    ...
    for img_name in os.listdir(img_dir):
        ...
        output = output[0]
        #print(output)
        outbox = filter_box(output,0.8,0.6)
        #print(outbox)
