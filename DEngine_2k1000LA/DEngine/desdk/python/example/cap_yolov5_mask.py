...
if __name__ == "__main__":
    ...
    net_file = "/DEngine/model/mask/net.bin"
    model_file = "/DEngine/model/mask/model.bin"
    ...
    while True:
        ...
        output = output[0]
        outbox = filter_box(output,0.5,0.45)
        
        CLASSES=('face','mask') # your code to extract these values from the model output
